        ...
        private static void Main(string[] args)
        {
            while (true)
            {
                ...
                if (Console.ReadLine().ToLower().Equals("y"))
                {
                    ...
                    double? OpenCircuitVoltagK = null;
                    switch (mode) { 
                       case "1":
                            ...
                            OpenCircuitVoltagK = Tcalc.OpenCircuitVoltage((double)high, (double)low);
                            if (OpenCircuitVoltagK == null) break;
                            double? output = OpenCircuitVoltagK * 100;
